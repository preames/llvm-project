...
; CHECK-NEXT:    vsetivli zero, 2, e16, mf8, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <2 x i8>, ptr %x
...
; RV64-NEXT:    vsetivli zero, 2, e64, mf2, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <2 x i32>, ptr %x
...
; RV64-NEXT:    vsetivli zero, 8, e64, m2, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <8 x i32>, ptr %x
...
; RV64-NEXT:    vsetivli zero, 16, e64, m4, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <16 x i32>, ptr %x
