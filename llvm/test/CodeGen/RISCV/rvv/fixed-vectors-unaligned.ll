...
; RV32-SLOW-NEXT:    vsetvli zero, zero, e16, mf2, tu, ma
...
; RV32-FAST-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
...
; RV64-FAST-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
...
; RV32-FAST-NEXT:    vluxei32.v v9, (zero), v8, v0.t
; RV32-FAST-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
...
; RV64-FAST-NEXT:    vluxei64.v v9, (zero), v8, v0.t
; RV64-FAST-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
...
; RV32-SLOW-NEXT:    vsetivli zero, 2, e8, mf2, ta, ma
...
; RV64-SLOW-NEXT:    vsetivli zero, 2, e8, mf2, ta, ma
...
; SLOW-NEXT:    vsetivli zero, 2, e8, mf2, ta, ma
