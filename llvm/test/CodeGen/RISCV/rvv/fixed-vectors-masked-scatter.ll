...
; RV64ZVE32F-NEXT:    vsetivli zero, 2, e8, m1, ta, ma
; RV64ZVE32F-NEXT:    vmv.x.s a0, v0
...
; RV32ZVE32F-NEXT:    vsetvli a2, zero, e32, mf4, ta, ma
...
; RV64ZVE32F-NEXT:  # %bb.1: # %cond.store
; RV64ZVE32F-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
...
; RV64ZVE32F-ZVFHMIN-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
